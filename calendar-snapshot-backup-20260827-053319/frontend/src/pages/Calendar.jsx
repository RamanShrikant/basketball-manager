      ...
      >
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-3 p-3 md:grid-cols-[0.9fr_1.1fr]">
          <div className="flex min-h-0 flex-col overflow-hidden rounded-xl border border-white/[0.08] bg-white/[0.025]">
            ...
            <div className="calendar-team-info-scroll min-h-0 flex-1 overflow-y-auto p-2">
              {roster.length ? roster.map((player, index) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center gap-2 border-b border-white/[0.06] px-1.5 py-2 last:border-b-0"
                  >
                    <div className="min-w-0 flex-1">
                      <div className="truncate text-[11px] font-bold text-neutral-200">{name}</div>
                      <div className="mt-0.5 text-[9px] font-semibold uppercase tracking-[0.08em] text-neutral-600">
                        {Number.isFinite(age) && age > 0 ? `Age ${age}` : "Rostered"}
                      </div>
                    </div>
                    {overall != null && (
                      <span className="shrink-0 text-[11px] font-black text-orange-300">{overall}</span>
                    )}
                  </div>
                );
              }) : (
