          ...
          {rows.length ? (
            <div className="grid gap-2">
              {isPosition ? rows.map((player, index) => {
                ...
                const portraitSize = 58 * visualTuning.responsiveScale;
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: portraitSize,
                        height: portraitSize,
                        transform: `translate(${visualTuning.headshot.x}px, ${visualTuning.headshot.y}px) scale(${visualTuning.headshot.scale})`,
                    ...
                    <div className="ml-3 min-w-0 flex-1 leading-tight">
                      <div
                        className="truncate text-sm font-black text-neutral-100"
                        style={{
                      ...
                      {age > 0 && (
                        <div
                          className="mt-1 text-[10px] font-bold uppercase tracking-[0.09em] text-neutral-500"
                          style={{
