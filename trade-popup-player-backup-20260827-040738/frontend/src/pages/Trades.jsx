              ...
              {isPosition ? rows.map((player, index) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center justify-between gap-4 rounded-xl border border-white/[0.08] bg-white/[0.035] px-4 py-3"
                  >
                    <div className="min-w-0">
                      <div className="truncate text-sm font-black text-neutral-100">{name}</div>
                      <div className="mt-1 text-[10px] font-bold uppercase tracking-[0.09em] text-neutral-500">
                        {primaryPositionOf(player) || detail.key}{age > 0 ? ` • Age ${age}` : ""}
                      </div>
                    </div>
                    <div className="flex shrink-0 items-center gap-2">
                      <div className="rounded-lg border border-white/10 bg-black/35 px-2.5 py-1.5 text-center">
                        <div className="text-[8px] font-black uppercase tracking-[0.12em] text-neutral-500">OVR</div>
                        <div className="text-sm font-black leading-none text-white">{overall}</div>
                      </div>
                      <div className="rounded-lg border border-orange-400/15 bg-orange-500/[0.06] px-2.5 py-1.5 text-center">
                        <div className="text-[8px] font-black uppercase tracking-[0.12em] text-orange-300/70">POT</div>
                        <div className="text-sm font-black leading-none text-orange-100">{potential}</div>
                      </div>
                    </div>
                  </div>
                );
