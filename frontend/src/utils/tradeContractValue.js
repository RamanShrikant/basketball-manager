...
const CONTRACT_OVERPAY_CAP_SHARE_FLOOR = 0.022;
const CONTRACT_OVERPAY_MARKET_BUFFER = 0.20;
const BASE_DOLLAR_BUFFER = 3_500_000;
const BAD_CONTRACT_TUNING_STRENGTH = 6.0;
